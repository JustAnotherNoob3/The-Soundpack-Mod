        ...
        public ModSettings.DropdownSetting SelectedSoundpack
        {
            get
            {
                ModSettings.DropdownSetting SelectedSoundpack = new()
                {
                    ...
                    Description = "The soundpack you are going to listen to. Restart the game for the options to update correctly if you made any changes to the organization of the folders.",
        ...
        public ModSettings.DropdownSetting SelectedSubFolder
        {
            get
            {
                ModSettings.DropdownSetting SelectedSubFolder = new()
                {
                    ...
                    Description = "The mod will only randomize soundpacks inside this folder. Restart the game for the options to update correctly if you made any changes to the organization of the folders.",
